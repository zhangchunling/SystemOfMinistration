...
function writeIframe()
{
    ...
    "    <table id=tableDay height=120 width=140 border=0 cellspacing=1 cellpadding=0>";
         ...
         " type=button value='&nbsp; &nbsp; 关闭' onclick='parent.closeCalendar()'></td></tr></table>"+
...
function WebCalendar() //初始化日历的设置
{
    ...
    this.darkColor  = "#1260A1";    //控件的暗色

    this.lightColor = "#FFFFFF";    //控件的亮色

    this.btnBgColor = "#BBC8D3";    //控件的按钮背景色
    this.wordColor  = "#333333";    //控件的文字颜色

    this.wordDark   = "#999999";    //控件的暗文字颜色
    this.dayBgColor = "#F5F5FA";    //日期数字背景色

    this.todayColor = "#FF0000";    //今天在日历上的标示背景色
    this.DarkBorder = "#F5F5FA";    //日期显示的立体表达色
...
function closeCalendar(){WebCalendar.objExport.value = '';hiddenCalendar();  }
