  ...
  <tr>
    ...
    <td width='80%' align="right" valign="bottom">
      ...
      <td align="right" height="26" style="padding-right:10px;line-height:26px;">
        	您好：<span class="username" ><font color="red"> ${emplInfo.name }</font></span>，欢迎使用中软高科实训项目管理系统！
        	
        	[<a href="jsp/else/index.jsp" target="_top">主页</a>]
        	[<a href="jsp/jsp_myinfo/modpassword.jsp"  target="_blank">修改密码</a>]
        	[<a href="javascript:void(0);" onClick="parent.location.href='jsp/else/login.jsp'" target="_login">注销退出</a>]&nbsp;
      </td>
      </tr>
      <tr>
