...
/**
 *查询数据库表里发件箱的所有的内容servlet 查询类
 * @author 樊丙富
 *2015-06-06
 */
public class QueryMailBoxServlet extends HttpServlet {//继承这个类
	...
	@Override//dopost方法
		...
		mailBox.setTotalSize(mailBoxservice.totalSize(mailBox));//赋值长度
		...
		request.getRequestDispatcher("jsp/jsp_mailbox/message.jsp").forward(request, response);
		}
