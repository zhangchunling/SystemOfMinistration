...
public class QueryByRidServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Role roles =( Role)roleService.QueryByRid(role);
	...
	if (roles!=null){
		...
		request.getRequestDispatcher("jsp/jsp_purview/updateRole.jsp").forward(
				request, response);
	}
