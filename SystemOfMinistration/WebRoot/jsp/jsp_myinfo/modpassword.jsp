...
<form name="form2" action="<%=basePath%>queryEmployeeByusername" method="post" >
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22"><input id="password" name="password"  /></td>
</tr>
<tr >
...
<td height="28" colspan=4 align=center>
	&nbsp;
	<a href="modpassword.html" class="coolbg">保存</a>
</td>
</tr>
</table>
