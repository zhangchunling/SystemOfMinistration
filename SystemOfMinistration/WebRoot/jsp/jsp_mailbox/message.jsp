...
<html>
  <head>
    ...
    <title>关于发件箱的jsp的页面</title>
<link rel="stylesheet" type="text/css" href="skin/css/base.css">

<script type="text/javascript" src="<%=basePath%>jsp/jsp_mailbox/js/message.js">message.js方法调用</script>
...
<!--  搜索表单  --> 
<form id="form3" name='form3' action="<%=basePath %>query.servlet.action" enctype="multipart/form-data" method='get'>
...
<!--  内容列表   --><!--调用删除方法  -->
<form id="form2" name="form2" action="<%=basePath %>deleteMailBoxServlet.action" method="post"/>
	...
	<td width="8%">操作</td>
		...
		<!--c标签的 循环  -->
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
						...
						<td>${mes.userName}</td>
						<td>${mes.time}</td>
						<td><a href="javascript:if(confirm('您真的忍心删除吗？'))window.location.
						 href='<%=basePath%>deleteMailBoxServlet.action?id=${mes.id}'">删除</a></td>
				</tr>		
				</c:forEach>
...
<td height="28" colspan="12">
	...
	<a href="<%=basePath %>portProductServlet.action" class="coolbg">&nbsp;导出Excel&nbsp;</a>
...
<tr align="right" bgcolor="#EEF4EA">
	<td height="36" colspan="12" align="center"><!--翻页代码 -->
		<%
    	 ...
    	 %>
    	<center>
	    	<a href="<%=basePath%>query.servlet.action?currentPage=1">首页</a>  
	    	<a href="<%=basePath%>query.servlet.action?currentPage=<%=upPage%>">上一页 </a> 
	    	<a href="<%=basePath%>query.servlet.action?currentPage=<%=nextPage%>">下一页</a>  
	    	<a href="<%=basePath%>query.servlet.action?currentPage=<%=mailBox.getTotalPage()%>">尾页</a>
    	</center>
	</td>
</tr>
</table>
