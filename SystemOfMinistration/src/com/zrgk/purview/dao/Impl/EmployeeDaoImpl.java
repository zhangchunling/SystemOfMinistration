...
public class EmployeeDaoImpl extends JdbcUtil implements EmployeeDaoInter {
	...
	public int QueryByRoleEid(Employee em) {
		int eid = 0;
		String sql = "select eid from employee where roles=? ";

		List<Object> params = new ArrayList<Object>();

		params.add(em.getRoles());
	...
	public void addEidAndRid(EidAndRid er) {
		...
		String sql = "insert into eid_rid (e_id, r_id) value(?,?) ";

		List<Object> params = new ArrayList<Object>();

		params.add(er.getE_id());

		params.add(er.getR_id());
	...
	public int QueryByRole(Employee em) {
		...
		StringBuffer sql = new StringBuffer(
				"select eid from employee where roles=?");
	...
	public void deleteByRidAndMid(EidAndRid er) {
		...
		String sql = " delete from eid_rid where e_id = ?";
